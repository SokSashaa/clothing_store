...
const ModalCreateCompany: FC<ModalCreateCompanyProps> = ({isOpenModal, setOpen}) => {
    const [form] = Form.useForm();
    const [valueINN, setValueINN] = useState("123");
    const [valueUser, setValueUser] = useState('')
    const [dataCompany, setDataCompany] = useState<getCompanyDADATA>(initialStateCompanyDADATA)
